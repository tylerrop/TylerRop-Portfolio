<div id="post-<?php the_ID(); ?>" <?php post_class('enigma_blog_full'); ?>>
	...
	<ul class="blog-date-left">
		...
		<li class="enigma_blog_comment">
			<i class="fa fa-comments-o"></i>
				<h6><?php comments_popup_link( '0', '1', '%', '', '-'); ?></h6>
		</li>
	...
	<div class="post-content-wrap">
		...
		<div class="enigma_fuul_blog_detail_padding">
			<h2>
				<?php 
					if(!is_single()) {?><a href="<?php the_permalink(); ?>"><?php } ?><?php the_title(); ?></a>
			</h2>
		    ...
		    ?>
		<!-- end enigma_fuul_blog_detail_padding-->
		</div>
