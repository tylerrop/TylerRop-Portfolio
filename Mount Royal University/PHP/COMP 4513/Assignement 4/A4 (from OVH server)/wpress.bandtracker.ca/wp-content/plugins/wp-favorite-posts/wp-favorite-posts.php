...
function wpfp_init() {
    ...
    $wpfp_options['added'] = "Added this Page to your Favorites";
    ...
    $wpfp_options['favorites_empty'] = "Your Favorites list is empty.";
    ...
    $wpfp_options['text_only_registered'] = "Only registered users can favorite pages.";
