                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td style="border-bottom:none;">
                                    ...
                                    <!--Favorites button used to add the artist to the favorites list-->
                                    <asp:LinkButton runat="server"  CssClass="btn btn-default blueLinks " ID="addFavButton" OnClick="AddArtistFav_OnClick" CommandArgument=<%# Eval("Id") %> >
