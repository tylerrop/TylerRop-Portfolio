 ...
 * https://wordpress.org/plugins/comprehensive-google-map-plugin/faq/
 * @package WordPress
 */
	...
	<div class="row enigma_blog_wrapper">
		<div class="col-md-8 col-sm-12">	
			...
			<?php 
				...
				$tag = str_replace(" ", "", $event);
				// shorten the string from the first comma to get just the venue name to use on instagram
