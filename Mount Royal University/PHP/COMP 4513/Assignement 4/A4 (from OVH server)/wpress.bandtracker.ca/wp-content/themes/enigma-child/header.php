...
<head>
	...
	<link rel="icon" href="http://www.wpress.bandtracker.ca/favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" href="http://www.wpress.bandtracker.ca/favicon.ico" type="image/x-icon" />
	<?php } ?>	
	<?php wp_head(); ?>
</head>
